...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 grid h-6 w-6 place-items-center rounded-none border-0 bg-transparent p-0 text-foreground/60 opacity-100 shadow-none transition-opacity group-[.destructive]:text-red-100 hover:bg-transparent hover:text-foreground group-[.destructive]:hover:text-white focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
      className,
    )}
    toast-close=""
    {...props}
